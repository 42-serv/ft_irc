...
ft::thread_specific_ptr<std::string> ft::irc::make_reply_base::my_user_name;
...
void ft::irc::make_reply_base::set_user_name(const std::string& str)
{
    if (ft::irc::make_reply_base::my_user_name.get())
    {
        *ft::irc::make_reply_base::my_user_name = str;
    }
    else
    {
        ft::irc::make_reply_base::my_user_name.reset(new std::string(str));
    }
}
